  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        ...
        return Positioned(
          right: 10.0 + offset.dx, //controla a posição x dos filhos do botao de expansão, coloque left, right ou width
          bottom: 0.0 + offset.dy, //controla a posição x dos filhos do botao de expansão
